    ...
    <div class="bg-white rounded-2xl shadow-2xl p-8">
        ...
        <form method="POST" action="/register" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" id="FirstName" name="FirstName" value="' . htmlspecialchars($data['FirstName'] ?? '') . '" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition">
            </div>

            <div>
                <label for="LastName" class="block text-sm font-medium text-gray-700 mb-2">Nom</label>
                <input type="text" id="LastName" name="LastName" value="' . htmlspecialchars($data['LastName'] ?? '') . '" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition">
            </div>
        ...
        <a href="/login" class="block w-full text-center bg-gray-50 hover:bg-gray-100 text-gray-700 font-semibold py-2 px-4 rounded-lg transition">
            Se connecter
        </a>
    </div>
</div>
